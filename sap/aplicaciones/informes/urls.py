...
from .views import informes, informe_proyecto_pdf, informe_proyecto, informe_solicitudes_pdf, informe_solicitudes, informe_items_pdf, informe_items, seleccionar_proyecto
