...
from .views import crear_solicitud, cancelar_solicitud, consultar_solicitud, administrar_solicitud_realizadas, administrar_solicitud_recibida, votar_solicitud
...
urlpatterns = patterns('',
                       ...
                       url(r'^adm_proyectos/solicitudes_realizadas/votar_solicitud/(?P<id_solicitud>\d+)/$', votar_solicitud),
                       )
