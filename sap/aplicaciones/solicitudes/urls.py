...
urlpatterns = patterns('',
                       ...
                       url(r'^adm_proyectos/solicitudes_realizadas/listar_proyectos/(?P<id_proyecto>\d+)/listar_fases/(?P<id_fase>\d+)/listar_items/(?P<id_item>\d+)/crear_solicitud/$', crear_solicitud),
