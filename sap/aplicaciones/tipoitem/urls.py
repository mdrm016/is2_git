...
from .views import adm_tipoitem, crear_tipoitem, listar_proyectos, listar_tipoitem, importar_tipoitem, eliminar_tipoitem, modificar_tipoitem, consultar_tipoitem, gestionar_tipoitem, agregar_tipo_atributo, quitar_tipo_atributo, subir_tipo_atributo, bajar_tipo_atributo
...
urlpatterns = patterns('',
        ...
        url(r'^adm_proyectos/gestionar/(?P<id_proyecto>\d+)/adm_tipos_item/listar_proyectos/$', listar_proyectos),
        url(r'^adm_proyectos/gestionar/(?P<id_proyecto>\d+)/adm_tipos_item/listar_proyectos/listar_tipoitem/(?P<proyecto_select>\d+)/importar_tipoitem/(?P<id_tipoitem>\d+)/$', importar_tipoitem),
        url(r'^adm_proyectos/gestionar/(?P<id_proyecto>\d+)/adm_tipos_item/listar_proyectos/listar_tipoitem/(?P<proyecto_select>\d+)/$', listar_tipoitem),
