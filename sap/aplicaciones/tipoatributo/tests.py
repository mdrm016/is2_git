...
class test_user(TestCase):
    ...
    fixtures = ['proyectos.json'] + ['tipos_item.json'] + ['tipos_atributo.json'] + ['users.json']
    ...
    def testtipoAtributoNuevo(self):
        ...
        self.user = User.objects.get(pk=1) 
        request = self.factory.post('/adm_proyectos/gestionar/1/adm_tipos_atributo/nuevo/', {'Nombre_tipo_atributo': 'Detalle', 'Tipo_de_dato': 'Texto', 'Precision': '0', 'Longitud': '50', 'Obligatorio': 'no', 'Descripcion': ''})
        request.user = self.user 
